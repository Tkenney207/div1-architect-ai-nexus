              ...
              <CardContent className="space-y-6">
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input placeholder="Your first name" className="border placeholder:text-navy-900" style={{ borderColor: '#D9D6D0', backgroundColor: '#F7F3ED', color: '#1A2B49' }} />
                  </div>
                  <div>
                    <label className="block text-sm font-medium mb-2" style={{ color: '#1A2B49' }}>Last Name</label>
                    <Input placeholder="Your last name" className="border placeholder:text-navy-900" style={{ borderColor: '#D9D6D0', backgroundColor: '#F7F3ED', color: '#1A2B49' }} />
                  </div>
                </div>
                <div>
                  <label className="block text-sm font-medium mb-2" style={{ color: '#1A2B49' }}>Email</label>
                  <Input type="email" placeholder="your@email.com" className="border placeholder:text-navy-900" style={{ borderColor: '#D9D6D0', backgroundColor: '#F7F3ED', color: '#1A2B49' }} />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-2" style={{ color: '#1A2B49' }}>Subject</label>
                  <Input placeholder="What's this about?" className="border placeholder:text-navy-900" style={{ borderColor: '#D9D6D0', backgroundColor: '#F7F3ED', color: '#1A2B49' }} />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-2" style={{ color: '#1A2B49' }}>Message</label>
                  <Textarea placeholder="Tell us more..." rows={5} className="border placeholder:text-navy-900" style={{ borderColor: '#D9D6D0', backgroundColor: '#F7F3ED', color: '#1A2B49' }} />
                </div>
